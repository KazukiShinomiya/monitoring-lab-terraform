...
## 稼働中サービス（リモート 10.0.0.220）

| サービス | ポート | URL / 認証 |
|---------|--------|-----------|
| Grafana | 3000 | http://10.0.0.220:3000 (admin/admin) |
| Prometheus | 9090 | http://10.0.0.220:9090 |
| Loki | 3100 | 内部のみ |
| cAdvisor | 8081 | http://10.0.0.220:8081 |
| WOW Exporter | 9200 | http://10.0.0.220:9200/metrics |
| Zabbix Web | 8080 | http://10.0.0.220:8080 (Admin/zabbix) |
| Vault | 8200 | http://10.0.0.220:8200 (token: root) |
