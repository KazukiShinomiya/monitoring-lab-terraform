...
scrape_configs:
  ...
  - job_name: 'node_exporter'
    ...
    static_configs:
      - targets:
          - '10.0.0.220:9100'   # monitoring server
...
Open Prometheus targets page at `http://10.0.0.220:9090/targets` and confirm the `node_exporter` job shows **UP** status.

### 5.4 Test a PromQL query

In Prometheus UI (`http://10.0.0.220:9090/graph`), run:
