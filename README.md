...
| コンポーネント | 用途 | アクセスURL |
|-------------|------|-----------|
| **Zabbix Server** | メトリクス収集・監視対象管理 | `http://10.0.0.220:8080` |
| **Zabbix Agent2** | Zabbix Server自己監視 | `10.0.0.220:10050` |
| **Prometheus** | 時系列メトリクス収集 | `http://10.0.0.220:9090` |
| **Grafana** | 可視化ダッシュボード | `http://10.0.0.220:3000` |
| **PostgreSQL** | Zabbixの永続ストレージ | `10.0.0.220:5432` |
