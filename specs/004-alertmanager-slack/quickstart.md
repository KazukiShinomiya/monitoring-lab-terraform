...
wsl -d Ubuntu-24.04 -e bash -c "
  ssh ubuntu@YOUR_SERVER_IP 'mkdir -p /home/ubuntu/monitoring-lab/alertmanager'
  scp /mnt/e/work/labo/config/alertmanager/alertmanager.yml ubuntu@YOUR_SERVER_IP:/home/ubuntu/monitoring-lab/alertmanager/alertmanager.yml
"
```
...
wsl -d Ubuntu-24.04 -e bash -c "
  scp /mnt/e/work/labo/config/prometheus/prometheus.yml ubuntu@YOUR_SERVER_IP:/home/ubuntu/monitoring-lab/prometheus/prometheus.yml
  ssh ubuntu@YOUR_SERVER_IP 'curl -X POST http://localhost:9090/-/reload'
"
```
...
wsl -d Ubuntu-24.04 -e bash -c "
  ssh ubuntu@YOUR_SERVER_IP 'docker stop monitoring-lab-cadvisor'
"
# 約1分後にSlack通知が届くことを確認
# その後コンテナを再起動して resolved 通知を確認
wsl -d Ubuntu-24.04 -e bash -c "
  ssh ubuntu@YOUR_SERVER_IP 'docker start monitoring-lab-cadvisor'
"
```
