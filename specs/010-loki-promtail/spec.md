...
**Created**: 2026-03-20
**Status**: Draft
**Input**: Loki + Promtail によるログ収集基盤の追加。既存の Prometheus + Grafana スタックにログ収集を統合し、メトリクスとログの相関分析を可能にする。Terragrunt の既存 docker_container モジュールを使ってリモートDocker環境（10.0.0.220）にデプロイする。
