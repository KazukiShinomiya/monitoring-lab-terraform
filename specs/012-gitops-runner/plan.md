...
GitHub Actions Self-hosted Runner を リモートサーバー (10.0.0.220) の Docker コンテナとして追加し、IaC 変更を自動検証・デプロイする GitOps 基盤を構築する。
...
**Target Platform**: Docker Engine on Ubuntu (10.0.0.220)
...
**目標**: 10.0.0.220 上に runner コンテナをデプロイし、GitHub にオンライン登録する
