...
- リモートサーバー (10.0.0.220) で monitoring-lab スタックが稼働中
...
wsl -d Ubuntu-24.04 -e bash -c "ssh ubuntu@10.0.0.220 'mkdir -p ~/monitoring-lab/tempo ~/monitoring-lab/otel-collector'"
...
# Tempo ヘルスチェック
wsl -d Ubuntu-24.04 -e bash -c "curl -s http://10.0.0.220:3200/ready"
# 期待値: "ready"
...
wsl -d Ubuntu-24.04 -e bash -c "ssh ubuntu@10.0.0.220 'docker run --rm \
...
1. Grafana を開く: http://10.0.0.220:3000
2. 左メニュー → **Explore**
3. データソースで **Tempo** を選択
...
1. Prometheus を開く: http://10.0.0.220:9090/targets
